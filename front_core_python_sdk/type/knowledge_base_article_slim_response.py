...
class RequiredKnowledgeBaseArticleSlimResponse(TypedDict):
    pass

class OptionalKnowledgeBaseArticleSlimResponse(TypedDict, total=False):
...
class KnowledgeBaseArticleSlimResponse(RequiredKnowledgeBaseArticleSlimResponse, OptionalKnowledgeBaseArticleSlimResponse):
    pass
