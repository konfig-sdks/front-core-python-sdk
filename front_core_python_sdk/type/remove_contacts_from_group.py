...
class RequiredRemoveContactsFromGroup(TypedDict):
...
class OptionalRemoveContactsFromGroup(TypedDict, total=False):
    pass

class RemoveContactsFromGroup(RequiredRemoveContactsFromGroup, OptionalRemoveContactsFromGroup):
    pass
