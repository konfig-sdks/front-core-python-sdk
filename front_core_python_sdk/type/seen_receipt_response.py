...
class RequiredSeenReceiptResponse(TypedDict):
    pass

class OptionalSeenReceiptResponse(TypedDict, total=False):
...
class SeenReceiptResponse(RequiredSeenReceiptResponse, OptionalSeenReceiptResponse):
    pass
