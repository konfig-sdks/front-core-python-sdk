...
class RequiredAnalyticsReportRequest(TypedDict):
...
class OptionalAnalyticsReportRequest(TypedDict, total=False):
...
class AnalyticsReportRequest(RequiredAnalyticsReportRequest, OptionalAnalyticsReportRequest):
    pass
