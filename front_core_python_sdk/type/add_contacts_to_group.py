...
class RequiredAddContactsToGroup(TypedDict):
...
class OptionalAddContactsToGroup(TypedDict, total=False):
    pass

class AddContactsToGroup(RequiredAddContactsToGroup, OptionalAddContactsToGroup):
    pass
