...
class RequiredMessageTemplateFolderResponse(TypedDict):
    pass

class OptionalMessageTemplateFolderResponse(TypedDict, total=False):
...
class MessageTemplateFolderResponse(RequiredMessageTemplateFolderResponse, OptionalMessageTemplateFolderResponse):
    pass
