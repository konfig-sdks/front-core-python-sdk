...
class RequiredKnowledgeBaseArticleResponse(TypedDict):
    pass

class OptionalKnowledgeBaseArticleResponse(TypedDict, total=False):
    ...
    # Article keywords
    keywords: typing.List[typing.Union[bool, date, datetime, dict, float, int, list, str, None]]
    ...
    last_edited_at: typing.Union[int, float]
...
class KnowledgeBaseArticleResponse(RequiredKnowledgeBaseArticleResponse, OptionalKnowledgeBaseArticleResponse):
    pass
