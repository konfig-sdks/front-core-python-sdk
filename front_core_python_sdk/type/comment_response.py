...
class RequiredCommentResponse(TypedDict):
    pass

class OptionalCommentResponse(TypedDict, total=False):
    ...
    posted_at: typing.Union[int, float]

    # List of files attached to the comment
    attachments: typing.List[Attachment]

class CommentResponse(RequiredCommentResponse, OptionalCommentResponse):
    pass
