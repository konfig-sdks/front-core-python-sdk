...
class RequiredOutboundMessage(TypedDict):
...
class OptionalOutboundMessage(TypedDict, total=False):
...
class OutboundMessage(RequiredOutboundMessage, OptionalOutboundMessage):
    pass
