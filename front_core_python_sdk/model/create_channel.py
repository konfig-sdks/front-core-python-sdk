...
class CreateChannel(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class settings(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["undo_send_time", "all_teammates_can_reply", "webhook_url", "sid", "auth_token", ], str]):
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["undo_send_time", "all_teammates_can_reply", "webhook_url", "sid", "auth_token", ], str]):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "name", "settings", "send_as", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "name", "settings", "send_as", ], str]):
        return super().get_item_oapg(name)
