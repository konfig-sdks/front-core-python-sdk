...
class CreatePrivateMessageTemplate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "body", "subject", "folder_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "body", "subject", "folder_id", ], str]):
