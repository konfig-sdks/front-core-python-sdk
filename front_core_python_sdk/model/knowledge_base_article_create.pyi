...
class KnowledgeBaseArticleCreate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["category_id", "author_id", "subject", "content", "status", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["category_id", "author_id", "subject", "content", "status", ], str]):
