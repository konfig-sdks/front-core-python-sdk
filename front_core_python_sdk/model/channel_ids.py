...
class ChannelIds(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["channel_ids", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["channel_ids", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        channel_ids: typing.Union[MetaOapg.properties.channel_ids, list, tuple, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
