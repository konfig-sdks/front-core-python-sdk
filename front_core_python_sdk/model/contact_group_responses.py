...
class ContactGroupResponses(
                ...
                class MetaOapg:
                    ...
                    class properties:
                        ...
                        class related(
                            ...
                            def __getitem__(self, name: typing.Union[typing_extensions.Literal["contacts", "owner", ], str]):
                            ...
                            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["contacts", "owner", ], str]):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["_links", "id", "name", "is_private", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["_links", "id", "name", "is_private", ], str]):
        return super().get_item_oapg(name)
