...
class TagIds(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["tag_ids", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tag_ids", ], str]):
