...
class ShiftResponseLinksRelated(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["teammates", "owner", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["teammates", "owner", ], str]):
