...
class CreateLink(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "external_url", "pattern", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "external_url", "pattern", ], str]):
