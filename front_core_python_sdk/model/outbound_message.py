...
class OutboundMessage(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["to", "body", "cc", "bcc", "sender_name", "subject", "author_id", "text", "options", "attachments", "signature_id", "should_add_default_signature", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["to", "body", "cc", "bcc", "sender_name", "subject", "author_id", "text", "options", "attachments", "signature_id", "should_add_default_signature", ], str]):
        return super().get_item_oapg(name)
