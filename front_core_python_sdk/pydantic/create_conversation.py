...
class CreateConversation(BaseModel):
    # Conversation type
    type: Literal["discussion"] = Field(alias='type')

    # Subject of the conversation
    subject: str = Field(alias='subject')

    # Details for the starter comment
    comment: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(alias='comment')
    ...
    teammate_ids: typing.Optional[typing.List[str]] = Field(None, alias='teammate_ids')
