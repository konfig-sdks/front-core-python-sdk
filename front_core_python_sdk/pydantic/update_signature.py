...
from front_core_python_sdk.pydantic.update_signature_channel_ids import UpdateSignatureChannelIds
...
class UpdateSignature(BaseModel):
    ...
    channel_ids: typing.Optional[UpdateSignatureChannelIds] = Field(None, alias='channel_ids')
