...
class SeenReceiptResponse(BaseModel):
    ...
    first_seen_at: typing.Optional[str] = Field(None, alias='first_seen_at')

    seen_by: typing.Optional[ContactHandle] = Field(None, alias='seen_by')
