...
class KnowledgeBaseArticleResponse(BaseModel):
    ...
    # Article keywords
    keywords: typing.Optional[typing.List[typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = Field(None, alias='keywords')
    ...
    last_edited_at: typing.Optional[typing.Union[int, float]] = Field(None, alias='last_edited_at')
