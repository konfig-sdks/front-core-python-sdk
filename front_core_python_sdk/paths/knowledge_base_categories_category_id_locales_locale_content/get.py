...
class BaseApi(api_client.Api):
    ...
    def _get_category_content_locale_mapped_args(
        self,
        category_id: str,
        locale: str,
    ...
    async def _aget_category_content_locale_oapg(
        self,
    ...
    def _get_category_content_locale_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetCategoryContentLocaleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_category_content_locale(
        self,
        category_id: str,
        locale: str,
        **kwargs,
        ...
        args = self._get_category_content_locale_mapped_args(
            category_id=category_id,
            locale=locale,
        )
        return await self._aget_category_content_locale_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_category_content_locale(
        self,
        category_id: str,
        locale: str,
    ) -> typing.Union[
        ...
        return self._get_category_content_locale_oapg(
            path_params=args.path,
        )

class GetCategoryContentLocale(BaseApi):
    ...
    async def aget_category_content_locale(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_category_content_locale(
            category_id=category_id,
            locale=locale,
            **kwargs,
        )
    ...
    def get_category_content_locale(
        ...
        raw_response = self.raw.get_category_content_locale(
            category_id=category_id,
            locale=locale,
        )
        if validate:
