...
class BaseApi(api_client.Api):
    ...
    def _delete_contact_mapped_args(
        self,
        contact_id: str,
    ...
    async def _adelete_contact_oapg(
        self,
...
class DeleteContactRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_contact(
        self,
        contact_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_contact_mapped_args(
            contact_id=contact_id,
        )
        return await self._adelete_contact_oapg(
    ...
    def delete_contact(
        ...
        return self._delete_contact_oapg(
            path_params=args.path,
        )
...
class DeleteContact(BaseApi):
    ...
    async def adelete_contact(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_contact(
            contact_id=contact_id,
            **kwargs,
        )
    ...
    def delete_contact(
        ...
        raw_response = self.raw.delete_contact(
            contact_id=contact_id,
        )
