...
class BaseApi(api_client.Api):
    ...
    def _get_one_contact_mapped_args(
        self,
        contact_id: str,
    ...
    async def _aget_one_contact_oapg(
        self,
...
class GetOneContactRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_one_contact(
        self,
        contact_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_one_contact_mapped_args(
            contact_id=contact_id,
        )
        return await self._aget_one_contact_oapg(
    ...
    def get_one_contact(
        ...
        return self._get_one_contact_oapg(
            path_params=args.path,
        )

class GetOneContact(BaseApi):
    ...
    async def aget_one_contact(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_one_contact(
            contact_id=contact_id,
            **kwargs,
        )
        if validate:
    ...
    def get_one_contact(
        ...
        raw_response = self.raw.get_one_contact(
            contact_id=contact_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
