...
class BaseApi(api_client.Api):
    ...
    def _get_knowledge_base_mapped_args(
        self,
    ...
    async def _aget_knowledge_base_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/knowledge_bases/{knowledge_base_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetKnowledgeBaseRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_knowledge_base(
        self,
        knowledge_base_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_knowledge_base_mapped_args(
            knowledge_base_id=knowledge_base_id,
        )
        return await self._aget_knowledge_base_oapg(
    ...
    def get_knowledge_base(
        ...
        return self._get_knowledge_base_oapg(
            path_params=args.path,
        )

class GetKnowledgeBase(BaseApi):
    ...
    async def aget_knowledge_base(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_knowledge_base(
            knowledge_base_id=knowledge_base_id,
            **kwargs,
        )
        if validate:
    ...
    def get_knowledge_base(
        ...
        raw_response = self.raw.get_knowledge_base(
            knowledge_base_id=knowledge_base_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
