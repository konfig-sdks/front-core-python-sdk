...
class BaseApi(api_client.Api):
    ...
    def _list_messages_in_reverse_chronological_order_mapped_args(
        self,
        conversation_id: str,
    ...
    async def _alist_messages_in_reverse_chronological_order_oapg(
        self,
    ...
    def _list_messages_in_reverse_chronological_order_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListMessagesInReverseChronologicalOrderRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_messages_in_reverse_chronological_order(
        self,
        conversation_id: str,
        limit: typing.Optional[int] = None,
        page_token: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_messages_in_reverse_chronological_order_mapped_args(
        ...
        return await self._alist_messages_in_reverse_chronological_order_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_messages_in_reverse_chronological_order(
        self,
        conversation_id: str,
        limit: typing.Optional[int] = None,
        page_token: typing.Optional[str] = None,
        ...
        return self._list_messages_in_reverse_chronological_order_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListMessagesInReverseChronologicalOrder(BaseApi):
    ...
    async def alist_messages_in_reverse_chronological_order(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_messages_in_reverse_chronological_order(
            conversation_id=conversation_id,
            limit=limit,
            page_token=page_token,
            sort_by=sort_by,
    ...
    def list_messages_in_reverse_chronological_order(
        ...
        raw_response = self.raw.list_messages_in_reverse_chronological_order(
            conversation_id=conversation_id,
            limit=limit,
            page_token=page_token,
            sort_by=sort_by,
