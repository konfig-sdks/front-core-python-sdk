...
class BaseApi(api_client.Api):
    ...
    def _get_workspace_mapped_args(
        self,
        team_id: str,
    ...
    async def _aget_workspace_oapg(
        self,
...
class GetWorkspaceRaw(BaseApi):
    ...
    async def aget_workspace(
        ...
        **kwargs,
        ...
        args = self._get_workspace_mapped_args(
            team_id=team_id,
        )
        return await self._aget_workspace_oapg(
...
class GetWorkspace(BaseApi):
    ...
    async def aget_workspace(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_workspace(
            team_id=team_id,
            **kwargs,
        )
        if validate:
    ...
    def get_workspace(
        ...
        raw_response = self.raw.get_workspace(
            team_id=team_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
