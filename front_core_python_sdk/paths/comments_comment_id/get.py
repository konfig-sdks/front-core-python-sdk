...
class GetCommentRaw(BaseApi):
    ...
    async def aget_comment(
        ...
        **kwargs,
        ...
        args = self._get_comment_mapped_args(
            comment_id=comment_id,
        )
        return await self._aget_comment_oapg(
    ...
    def get_comment(
        ...
        return self._get_comment_oapg(
            path_params=args.path,
        )

class GetComment(BaseApi):
    ...
    async def aget_comment(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_comment(
            comment_id=comment_id,
            **kwargs,
        )
        if validate:
    ...
    def get_comment(
        ...
        raw_response = self.raw.get_comment(
            comment_id=comment_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
