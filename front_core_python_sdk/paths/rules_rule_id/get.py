...
class GetRuleRaw(BaseApi):
    ...
    async def aget_rule(
        ...
        **kwargs,
        ...
        args = self._get_rule_mapped_args(
            rule_id=rule_id,
        )
        return await self._aget_rule_oapg(
...
class GetRule(BaseApi):
    ...
    async def aget_rule(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_rule(
            rule_id=rule_id,
            **kwargs,
        )
        if validate:
    ...
    def get_rule(
        ...
        raw_response = self.raw.get_rule(
            rule_id=rule_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
