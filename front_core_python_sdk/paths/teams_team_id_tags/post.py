...
class BaseApi(api_client.Api):
    ...
    def _create_team_tag_mapped_args(
        self,
        name: str,
        team_id: str,
    ...
    async def _acreate_team_tag_oapg(
        self,
...
class CreateTeamTagRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_team_tag(
        self,
        name: str,
        team_id: str,
        description: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_team_tag_mapped_args(
            name=name,
            team_id=team_id,
        ...
        return await self._acreate_team_tag_oapg(
            body=args.body,
    ...
    def create_team_tag(
        ...
        return self._create_team_tag_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateTeamTag(BaseApi):
    ...
    async def acreate_team_tag(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_team_tag(
            name=name,
            team_id=team_id,
            description=description,
            highlight=highlight,
    ...
    def create_team_tag(
        ...
        raw_response = self.raw.create_team_tag(
            name=name,
            team_id=team_id,
            description=description,
            highlight=highlight,
