...
class BaseApi(api_client.Api):
    ...
    def _delete_template_mapped_args(
        self,
    ...
    async def _adelete_template_oapg(
        self,
...
class DeleteTemplateRaw(BaseApi):
    ...
    async def adelete_template(
        ...
        **kwargs,
        ...
        args = self._delete_template_mapped_args(
            message_template_id=message_template_id,
        )
        return await self._adelete_template_oapg(
...
class DeleteTemplate(BaseApi):
    ...
    async def adelete_template(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_template(
            message_template_id=message_template_id,
            **kwargs,
        )
    ...
    def delete_template(
        ...
        raw_response = self.raw.delete_template(
            message_template_id=message_template_id,
        )
