...
class BaseApi(api_client.Api):
    ...
    def _get_template_by_id_mapped_args(
        self,
    ...
    async def _aget_template_by_id_oapg(
        self,
...
class GetTemplateByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_template_by_id(
        self,
        message_template_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_template_by_id_mapped_args(
            message_template_id=message_template_id,
        )
        return await self._aget_template_by_id_oapg(
    ...
    def get_template_by_id(
        ...
        return self._get_template_by_id_oapg(
            path_params=args.path,
        )

class GetTemplateById(BaseApi):
    ...
    async def aget_template_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_template_by_id(
            message_template_id=message_template_id,
            **kwargs,
        )
        if validate:
    ...
    def get_template_by_id(
        ...
        raw_response = self.raw.get_template_by_id(
            message_template_id=message_template_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
