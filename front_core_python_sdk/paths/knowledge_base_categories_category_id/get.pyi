    ...
    async def _aget_category_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/knowledge_base_categories/{category_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetCategoryRaw(BaseApi):
    ...
    async def aget_category(
        ...
        **kwargs,
        ...
        args = self._get_category_mapped_args(
            category_id=category_id,
        )
        return await self._aget_category_oapg(
...
class GetCategory(BaseApi):
    ...
    async def aget_category(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_category(
            category_id=category_id,
            **kwargs,
        )
        if validate:
    ...
    def get_category(
        ...
        raw_response = self.raw.get_category(
            category_id=category_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
