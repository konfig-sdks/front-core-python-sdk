...
from front_core_python_sdk.model.contact_notes_list_response import ContactNotesListResponse as ContactNotesListResponseSchema

from front_core_python_sdk.type.contact_notes_list_response import ContactNotesListResponse

from ...api_client import Dictionary
from front_core_python_sdk.pydantic.contact_notes_list_response import ContactNotesListResponse as ContactNotesListResponsePydantic
...
SchemaFor202ResponseBodyApplicationJson = ContactNotesListResponseSchema


@dataclass
class ApiResponseFor202(api_client.ApiResponse):
    body: ContactNotesListResponse
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContactNotesListResponsePydantic:
        raw_response = await self.raw.alist(
            contact_id=contact_id,
            **kwargs,
        )
        if validate:
            return ContactNotesListResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ContactNotesListResponsePydantic, raw_response.body)
