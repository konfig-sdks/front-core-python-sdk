...
from front_core_python_sdk.model.reply_draft import ReplyDraft as ReplyDraftSchema

from front_core_python_sdk.type.reply_draft import ReplyDraft

from ...api_client import Dictionary
from front_core_python_sdk.pydantic.reply_draft import ReplyDraft as ReplyDraftPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ReplyDraftSchema


request_body_reply_draft = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_draft_reply_mapped_args(
        self,
        author_id: str,
        body: str,
        channel_id: str,
    ...
    async def _acreate_draft_reply_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_reply_draft.serialize(body, content_type)
...
class CreateDraftReplyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_draft_reply(
        self,
        author_id: str,
        body: str,
        channel_id: str,
        ...
        **kwargs,
        ...
        args = self._create_draft_reply_mapped_args(
            body=body,
            author_id=author_id,
            body=body,
        ...
        return await self._acreate_draft_reply_oapg(
            body=args.body,
    ...
    def create_draft_reply(
        ...
        return self._create_draft_reply_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateDraftReply(BaseApi):
    ...
    async def acreate_draft_reply(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_draft_reply(
            body=body,
            author_id=author_id,
            body=body,
            channel_id=channel_id,
    ...
    def create_draft_reply(
        ...
        raw_response = self.raw.create_draft_reply(
            body=body,
            author_id=author_id,
            body=body,
            channel_id=channel_id,
