...
class BaseApi(api_client.Api):
    ...
    def _create_company_tag_mapped_args(
        self,
        name: str,
    ...
    async def _acreate_company_tag_oapg(
        self,
...
class CreateCompanyTagRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_company_tag(
        self,
        name: str,
        description: typing.Optional[str] = None,
        highlight: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_company_tag_mapped_args(
            name=name,
            description=description,
            highlight=highlight,
            is_visible_in_conversation_lists=is_visible_in_conversation_lists,
        )
        return await self._acreate_company_tag_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_company_tag(
        ...
        return self._create_company_tag_oapg(
            body=args.body,
        )

class CreateCompanyTag(BaseApi):
    ...
    async def acreate_company_tag(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_company_tag(
            name=name,
            description=description,
            highlight=highlight,
            is_visible_in_conversation_lists=is_visible_in_conversation_lists,
    ...
    def create_company_tag(
        ...
        raw_response = self.raw.create_company_tag(
            name=name,
            description=description,
            highlight=highlight,
            is_visible_in_conversation_lists=is_visible_in_conversation_lists,
