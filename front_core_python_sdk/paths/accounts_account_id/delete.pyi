...
class BaseApi(api_client.Api):
    ...
    def _delete_account_mapped_args(
        self,
        account_id: str,
    ...
    async def _adelete_account_oapg(
        self,
...
class DeleteAccountRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_account(
        self,
        account_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_account_mapped_args(
            account_id=account_id,
        )
        return await self._adelete_account_oapg(
...
class DeleteAccount(BaseApi):
    ...
    async def adelete_account(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_account(
            account_id=account_id,
            **kwargs,
        )
    ...
    def delete_account(
        ...
        raw_response = self.raw.delete_account(
            account_id=account_id,
        )
