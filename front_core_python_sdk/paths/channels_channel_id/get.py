...
class GetChannelRaw(BaseApi):
    ...
    async def aget_channel(
        ...
        **kwargs,
        ...
        args = self._get_channel_mapped_args(
            channel_id=channel_id,
        )
        return await self._aget_channel_oapg(
    ...
    def get_channel(
        ...
        return self._get_channel_oapg(
            path_params=args.path,
        )

class GetChannel(BaseApi):
    ...
    async def aget_channel(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_channel(
            channel_id=channel_id,
            **kwargs,
        )
        if validate:
    ...
    def get_channel(
        ...
        raw_response = self.raw.get_channel(
            channel_id=channel_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
