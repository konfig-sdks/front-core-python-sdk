...
from front_core_python_sdk.model.create_draft import CreateDraft as CreateDraftSchema

from front_core_python_sdk.type.create_draft import CreateDraft

from ...api_client import Dictionary
from front_core_python_sdk.pydantic.create_draft import CreateDraft as CreateDraftPydantic
...
# body param
SchemaForRequestBodyApplicationJson = CreateDraftSchema


request_body_create_draft = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_new_draft_message_mapped_args(
        self,
        author_id: str,
        body: str,
        channel_id: str,
    ...
    async def _acreate_new_draft_message_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/channels/{channel_id}/drafts',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_create_draft.serialize(body, content_type)
    ...
    def _create_new_draft_message_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateNewDraftMessageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_draft_message(
        self,
        author_id: str,
        body: str,
        channel_id: str,
        ...
        **kwargs,
        ...
        args = self._create_new_draft_message_mapped_args(
            body=body,
            author_id=author_id,
            body=body,
        ...
        return await self._acreate_new_draft_message_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def create_new_draft_message(
        self,
        author_id: str,
        body: str,
        channel_id: str,
        ...
        return self._create_new_draft_message_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateNewDraftMessage(BaseApi):
    ...
    async def acreate_new_draft_message(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_draft_message(
            body=body,
            author_id=author_id,
            body=body,
            channel_id=channel_id,
    ...
    def create_new_draft_message(
        ...
        raw_response = self.raw.create_new_draft_message(
            body=body,
            author_id=author_id,
            body=body,
            channel_id=channel_id,
