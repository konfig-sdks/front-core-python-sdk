...
class BaseApi(api_client.Api):
    ...
    def _create_tag_oldest_team_mapped_args(
        self,
        name: str,
    ...
    async def _acreate_tag_oldest_team_oapg(
        self,
    ...
    def _create_tag_oldest_team_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateTagOldestTeamRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_tag_oldest_team(
        self,
        name: str,
        description: typing.Optional[str] = None,
        highlight: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_tag_oldest_team_mapped_args(
            name=name,
            description=description,
            highlight=highlight,
            is_visible_in_conversation_lists=is_visible_in_conversation_lists,
        )
        return await self._acreate_tag_oldest_team_oapg(
            body=args.body,
            **kwargs,
        )
    
    def create_tag_oldest_team(
        self,
        name: str,
        description: typing.Optional[str] = None,
        highlight: typing.Optional[str] = None,
        ...
        return self._create_tag_oldest_team_oapg(
            body=args.body,
        )

class CreateTagOldestTeam(BaseApi):
    ...
    async def acreate_tag_oldest_team(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_tag_oldest_team(
            name=name,
            description=description,
            highlight=highlight,
            is_visible_in_conversation_lists=is_visible_in_conversation_lists,
    ...
    def create_tag_oldest_team(
        ...
        raw_response = self.raw.create_tag_oldest_team(
            name=name,
            description=description,
            highlight=highlight,
            is_visible_in_conversation_lists=is_visible_in_conversation_lists,
