...
class BaseApi(api_client.Api):
    ...
    def _mark_message_seen_mapped_args(
        self,
        message_id: str,
    ...
    async def _amark_message_seen_oapg(
        self,
...
class MarkMessageSeenRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amark_message_seen(
        self,
        message_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._mark_message_seen_mapped_args(
            message_id=message_id,
        )
        return await self._amark_message_seen_oapg(
            body=args.body,
    ...
    def mark_message_seen(
        ...
        return self._mark_message_seen_oapg(
            body=args.body,
            path_params=args.path,
        )

class MarkMessageSeen(BaseApi):
    ...
    async def amark_message_seen(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.amark_message_seen(
            message_id=message_id,
            **kwargs,
        )
    ...
    def mark_message_seen(
        ...
        raw_response = self.raw.mark_message_seen(
            message_id=message_id,
        )
