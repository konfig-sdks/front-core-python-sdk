...
class BaseApi(api_client.Api):
    ...
    def _create_team_contact_mapped_args(
        self,
    ...
    async def _acreate_team_contact_oapg(
        self,
...
class CreateTeamContactRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_team_contact(
        self,
        handles: typing.List[ContactHandle],
        team_id: str,
        description: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_team_contact_mapped_args(
            body=body,
            handles=handles,
            team_id=team_id,
        ...
        return await self._acreate_team_contact_oapg(
            body=args.body,
    ...
    def create_team_contact(
        ...
        return self._create_team_contact_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateTeamContact(BaseApi):
    ...
    async def acreate_team_contact(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_team_contact(
            body=body,
            handles=handles,
            team_id=team_id,
            description=description,
    ...
    def create_team_contact(
        ...
        raw_response = self.raw.create_team_contact(
            body=body,
            handles=handles,
            team_id=team_id,
            description=description,
