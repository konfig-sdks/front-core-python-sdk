...
SchemaFor200ResponseBodyApplicationJson = LinkResponseSchema
...
class GetLinkRaw(BaseApi):
    ...
    async def aget_link(
        ...
        **kwargs,
        ...
        args = self._get_link_mapped_args(
            link_id=link_id,
        )
        return await self._aget_link_oapg(
...
class GetLink(BaseApi):
    ...
    async def aget_link(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_link(
            link_id=link_id,
            **kwargs,
        )
        if validate:
    ...
    def get_link(
        ...
        raw_response = self.raw.get_link(
            link_id=link_id,
        )
        if validate:
            return LinkResponsePydantic(**raw_response.body)
