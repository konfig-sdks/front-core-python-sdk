    ...
    async def _adelete_group_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/contact_groups/{contact_group_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class DeleteGroupRaw(BaseApi):
    ...
    async def adelete_group(
        ...
        **kwargs,
        ...
        args = self._delete_group_mapped_args(
            contact_group_id=contact_group_id,
        )
        return await self._adelete_group_oapg(
...
class DeleteGroup(BaseApi):
    ...
    async def adelete_group(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_group(
            contact_group_id=contact_group_id,
            **kwargs,
        )
    ...
    def delete_group(
        ...
        raw_response = self.raw.delete_group(
            contact_group_id=contact_group_id,
        )
