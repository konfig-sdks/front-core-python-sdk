...
class DeleteTagRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_tag(
        self,
        tag_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_tag_mapped_args(
            tag_id=tag_id,
        )
        return await self._adelete_tag_oapg(
...
class DeleteTag(BaseApi):
    ...
    async def adelete_tag(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_tag(
            tag_id=tag_id,
            **kwargs,
        )
    ...
    def delete_tag(
        ...
        raw_response = self.raw.delete_tag(
            tag_id=tag_id,
        )
