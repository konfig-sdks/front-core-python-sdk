...
SchemaFor200ResponseBodyApplicationJson = TagResponseSchema
...
class GetTagRaw(BaseApi):
    ...
    async def aget_tag(
        ...
        **kwargs,
        ...
        args = self._get_tag_mapped_args(
            tag_id=tag_id,
        )
        return await self._aget_tag_oapg(
...
class GetTag(BaseApi):
    ...
    async def aget_tag(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_tag(
            tag_id=tag_id,
            **kwargs,
        )
        if validate:
