...
# body param
SchemaForRequestBodyApplicationJson = ContactHandleSchema


request_body_contact_handle = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _add_new_handle_mapped_args(
        self,
        handle: str,
        source: str,
        contact_id: str,
    ...
    async def _aadd_new_handle_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_contact_handle.serialize(body, content_type)
...
class AddNewHandleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_new_handle(
        self,
        handle: str,
        source: str,
        contact_id: str,
        **kwargs,
        ...
        args = self._add_new_handle_mapped_args(
            handle=handle,
            source=source,
            contact_id=contact_id,
        )
        return await self._aadd_new_handle_oapg(
            body=args.body,
    ...
    def add_new_handle(
        ...
        return self._add_new_handle_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddNewHandle(BaseApi):
    ...
    async def aadd_new_handle(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_new_handle(
            handle=handle,
            source=source,
            contact_id=contact_id,
            **kwargs,
    ...
    def add_new_handle(
        ...
        raw_response = self.raw.add_new_handle(
            handle=handle,
            source=source,
            contact_id=contact_id,
        )
