...
class BaseApi(api_client.Api):
    ...
    def _create_teammate_tag_mapped_args(
        self,
        name: str,
        teammate_id: str,
    ...
    async def _acreate_teammate_tag_oapg(
        self,
...
class CreateTeammateTagRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_teammate_tag(
        self,
        name: str,
        teammate_id: str,
        description: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_teammate_tag_mapped_args(
            name=name,
        ...
        return await self._acreate_teammate_tag_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def create_teammate_tag(
        self,
        name: str,
        teammate_id: str,
        description: typing.Optional[str] = None,
        ...
        return self._create_teammate_tag_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateTeammateTag(BaseApi):
    ...
    async def acreate_teammate_tag(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_teammate_tag(
            name=name,
            teammate_id=teammate_id,
            description=description,
            highlight=highlight,
    ...
    def create_teammate_tag(
        ...
        raw_response = self.raw.create_teammate_tag(
            name=name,
            teammate_id=teammate_id,
            description=description,
            highlight=highlight,
