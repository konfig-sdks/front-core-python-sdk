...
class BaseApi(api_client.Api):
    ...
    def _create_new_contact_mapped_args(
        self,
    ...
    async def _acreate_new_contact_oapg(
        self,
...
class CreateNewContactRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_contact(
        self,
        handles: typing.List[ContactHandle],
        description: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_new_contact_mapped_args(
            body=body,
            handles=handles,
        ...
        return await self._acreate_new_contact_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_new_contact(
        ...
        return self._create_new_contact_oapg(
            body=args.body,
        )

class CreateNewContact(BaseApi):
    ...
    async def acreate_new_contact(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_contact(
            body=body,
            handles=handles,
            description=description,
            name=name,
    ...
    def create_new_contact(
        ...
        raw_response = self.raw.create_new_contact(
            body=body,
            handles=handles,
            description=description,
            name=name,
